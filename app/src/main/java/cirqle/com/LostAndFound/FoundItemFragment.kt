...
class FoundItemFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val view=inflater.inflate(R.layout.fragment_found_item, container, false)
     ...
     private fun loaddata() {
        val collegeName= Utility.getUserDetails(requireContext())?.collegeName
        val reqCall= BuilderRetrofit.builService(ApiInterface::class.java).get_lost_found_post(collegeName!!,"Found")
