...
class AddFeedActivity : AppCompatActivity() {
    ...
    private lateinit var anonymosSwitch:SwitchCompat
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        anonymosSwitch.setOnCheckedChangeListener { buttonView, isChecked ->
            if (isChecked) {
                isAnonymos="Yes"
                anonymosSwitch.trackTintList= ColorStateList.valueOf(ContextCompat.getColor(this, R.color.light_green))
                anonymosSwitch.setTextColor(ContextCompat.getColor(this, R.color.succes_green))
                anonymosSwitch.thumbTintList=ColorStateList.valueOf(ContextCompat.getColor(this, R.color.succes_green))
                Toast.makeText(this, "Switch is ON", Toast.LENGTH_SHORT).show()
            } else {
                isAnonymos="No"
                anonymosSwitch.trackTintList= ColorStateList.valueOf(ContextCompat.getColor(this, R.color.light_gray))
                anonymosSwitch.setTextColor(ContextCompat.getColor(this, R.color.dark_txt_gray))
                anonymosSwitch.thumbTintList=ColorStateList.valueOf(ContextCompat.getColor(this, R.color.txt_gray))
...
//            val selectedImageUris = mutableListOf<Uri>()
    ...
    fun init(){
        ...
        anonymosSwitch=findViewById(R.id.anonymosSwitch)
    }
}